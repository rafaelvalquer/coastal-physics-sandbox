import { useCallback,useState } from "react";import { GameCanvas } from "../../../components/GameCanvas.jsx";import { ScenarioToolbar } from "../ScenarioTools/ScenarioToolbar.jsx";import { DisasterPanel } from "../DisasterEditor/DisasterPanel.jsx";import { DisasterTimeline } from "../Timeline/DisasterTimeline.jsx";import { SimulationControls } from "../Simulation/SimulationControls.jsx";import { LiveMetrics } from "../Simulation/LiveMetrics.jsx";import { AnalysisScreen } from "../Analysis/AnalysisScreen.jsx";import { ChallengeBrowser } from "../Challenges/ChallengeBrowser.jsx";import { ChallengeHUD } from "../Challenges/ChallengeHUD.jsx";import { EventLog } from "../Analysis/EventLog.jsx";import { LabOverlayRail } from "./LabOverlayRail.jsx";import { LabInspector } from "./LabInspector.jsx";
...
export function LabShell(){
 ...
 return <main className={"extreme-lab-shell "+(photo?"photo-mode":"")}>
  ...
  {!photo&&<><header className="lab-topbar"><div className="lab-brand"><small>COASTAL PHYSICS</small><strong>EXTREME WEATHER LAB</strong><span>{snapshot?.experiment?.code||"—"}</span></div><SimulationControls engine={engine} snapshot={snapshot} onChallenges={()=>setChallengesOpen(true)} onPhoto={togglePhoto}/></header><ChallengeHUD snapshot={snapshot}/>
   ...
   {challengesOpen&&<ChallengeBrowser engine={engine} snapshot={snapshot} onClose={()=>setChallengesOpen(false)}/>}
