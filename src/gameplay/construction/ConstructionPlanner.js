...
export class ConstructionPlanner {
  constructor({validator,structuralSystem}){this.validator=validator;this.structuralSystem=structuralSystem;this.selectedType=null;this.category=null;}
  select(type,category=null){this.selectedType=type;this.category=category;}
  clear(){this.selectedType=null;this.category=null;}
  preview(position){
  ...
  plan(position,{priority="NORMAL",desiredWorkers=null}={}){
